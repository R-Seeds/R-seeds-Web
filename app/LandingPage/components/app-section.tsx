...
const AppSection = () => {
  ...
  return (
    <section 
      id="app-section"
      ref={sectionRef}
      className="relative w-full bg-gradient-to-br bg-[#1540350A] pt-0 sm:pt-2 md:pt-4 lg:pt-6 xl:pt-8 pb-10 sm:pb-12 md:pb-16 lg:pb-20 xl:pb-24 2xl:pb-28 overflow-hidden"
    >

...
const messages: Message[] = [
  ...
  {
    id: 2,
    text: "Can you tell me how your project is going so far?",
    sender: "contact",
    time: "12:05 pm",
  },
  ...
  {
    id: 4,
    text: "We're currently working on the navigation system, adding AI mapping features.",
    sender: "contact",
    time: "12:05 pm",
  },
  {
    id: 5,
    text: "Nice! When will it finish?",
    sender: "user",
    time: "12:05 pm",
  },
  {
    id: 6,
    text: "Next month. Your help means a lot",
    sender: "contact",
    time: "12:05 pm",
    emoji: "💙💙💙",
  },
          ...
          <div className="rounded-2xl bg-white p-6 shadow-card h-[600px] flex flex-col">
            ...
            <div className="space-y-3 flex-1 overflow-y-auto">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((id) => (
                <Link key={id} href={`/graduate/chat/${id}`}>
                  <div
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-sm text-slate-600 truncate">
                        Hello, It will be finished next week
                      </div>
                    </div>
              ...
              {messages.map((message) => (
                ...
                >
                  ...
                  >
                    ...
                    {message.emoji && (
                      <div className="mt-1 text-sm">{message.emoji}</div>
                    )}
                    <div

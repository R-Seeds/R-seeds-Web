...
export default function EditProjectPage() {
  ...
  const [mission, setMission] = useState(
    "To provide reliable, versatile, and cost-effective drone solutions that empower communities, businesses, and organizations."
  );
      ...
      <div className="flex justify-center items-start pt-10 px-2">
        <div className="relative w-full max-w-5xl rounded-2xl bg-white shadow-xl p-12 border mx-auto">
          <div className="flex items-center gap-6 mb-10">
            ...
            <h1 className="text-2xl font-bold text-[#00c399] text-center w-full">
              Edit Project
            </h1>
          </div>
          {/* FORM START */}
          <form className="space-y-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {categories.map((cat, i) => (
                  <span
                    key={i}
                    className="flex items-center border border-brand text-brand bg-brand/10 px-2 py-1 rounded-full text-xs"
                  >
                    {cat}
                    <button
                      type="button"
                      className="ml-1 text-brand hover:text-red-500"
                    >
                      &times;
                    </button>
                  </span>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                {addingMember ? (
                  ...
                  <button
                    type="button"
                    className="w-full bg-gray-100 border border-dashed border-gray-400 text-gray-600 rounded py-2 font-semibold mt-1"
              ...
              <div className="space-y-2 mb-2">
                {milestones.map((m, i) => (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <button
                      type="button"
                      className="text-brand hover:text-[#00b387] p-1"
                    >
                      <svg
                        width="16"
                        height="16"
            ...
            <div>
              ...
              <input
                type="text"
                value={fundingGoal}
                className="w-full border rounded px-3 py-2 bg-[#fafbfc] mb-2"
                readOnly
              />
              <input
                type="text"
            ...
            <div>
              ...
              <div className="space-y-2 mb-2">
                {links.map((l, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <span className="flex-1 text-sm underline text-brand">
                      {l.label}: {l.url}
                    </span>
                    <button
                      type="button"

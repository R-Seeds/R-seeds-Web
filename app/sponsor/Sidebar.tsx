...
const items = [
  { icon: Home, label: "Home", href: "/sponsor" },
  { icon: Compass, label: "Explore", href: "/sponsor/explore" },
  { icon: Coins, label: "My Contributions", href: "/sponsor/fundings"  },
  { icon: MessageCircleMore, label: "Chat", href: "/sponsor/chat" },
  { icon: UserRound, label: "Profile", href: "/sponsor/profile" },
];
...
export default function Sidebar() {
  ...
  const activeIdx = items.findIndex((i) =>
    i.href === "/sponsor" ? pathname === i.href : pathname.startsWith(i.href)
  );
